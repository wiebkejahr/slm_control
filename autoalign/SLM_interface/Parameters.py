...
class param():
    ...
    def init_defaults(self):
        self.general = {
                    ...
                    "size_slm_mm" : [7.5, 10],
                    "slm_px" : 0.0125,
                    "slm_range" : 255, # somewhere, I'll have to scale by the SLM brightness for given wavelength
                    "size_full" : [600, 792],
                    "phasewrap" : 1,
                    "size_slm" : [600, 396],
                    "displaywidth" : 300,
                    "laser_radius" : 1.2,
                    "objective": "100xOil NA 1.4",
                    "path" : 'patterns/',                    
...
#                            }
    ...
    def update(self, p):
        ...
        self.general = {
                    ...
                    "slm_range" : daddy.p.general["slm_range"], # somewhere, I'll have to scale by the SLM brightness for given wavelength
