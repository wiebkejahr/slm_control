...
class Main_Window(QtWidgets.QMainWindow):
    ...
    def __init__(self, app, parent=None):
        ...
        self.slm_radius = inits.calc_slmradius(self.p, 
    ...
    def init_data(self):
        ...
        #TODO: pass through into autoalign class
    ...
    def create_main_frame(self):
        ...
        hbox = QtWidgets.QHBoxLayout()
        self.crea_but(hbox, AA.auto_align, "Auto Align", self.params)
        self.crea_but(hbox, AA.automate, "Auto-test")
        hbox.setContentsMargins(0,0,0,0)
        vbox.addLayout(hbox)
    ...
    def radius_changed(self):
        ...
        self.slm_radius = inits.calc_slmradius(self.p, self.radius_input, 1)
        self.init_zernikes()
        self.recalc_images()
